...
public class ZombieControl : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        if (Manager.Setting.masterAudioMixerGroup != null)
        {
            AudioMixerGroup zombieAudioMixer = Manager.Setting.masterAudioMixerGroup.audioMixer.FindMatchingGroups("SFX")[0];
